...
namespace ullblocks
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "ullblocks, Onion Unprll Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable Unprll total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.unprll/lmdb")
                ...
                ("daemon-url,d", value<string>()->default_value("http:://127.0.0.1:21150"),
                 "Unprll daemon url");
