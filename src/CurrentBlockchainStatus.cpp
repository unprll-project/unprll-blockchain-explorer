...
CurrentBlockchainStatus::load_current_emission_amount()
{
    ...
    string last_saved_emmision = ullblocks::read(emmision_saved_file);
...
bf::path CurrentBlockchainStatus::blockchain_path {"/home/mwo/.unprll/lmdb"};
...
string CurrentBlockchainStatus::daemon_url {"http:://127.0.0.1:21150"};
...
ullblocks::MicroCore*  CurrentBlockchainStatus::mcore {nullptr};
}
